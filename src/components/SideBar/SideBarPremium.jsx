  ...
  return (
    <>
      <div className="list-group mt-3 mx-2">
        <h6 className="text-light ms-3">Estadisticas</h6>
      ...
      <div className="list-group mt-3 mx-2">
        <h6 className="text-light ms-3">Administracion</h6>
        ...
        <NavLink className="nav-link" to="alexis">
          <button
            type="button"
            className="list-group-item list-group-item-action list-group-item-dark d-flex align-items-center gap-2"
            aria-current="true"
        ...
        <NavLink className="nav-link" to="summaries">
          <button
            type="button"
            className="list-group-item list-group-item-action list-group-item-dark d-flex align-items-center gap-2"
            aria-current="true"
